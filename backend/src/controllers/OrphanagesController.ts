...
import orpahanageView from '../views/orphanages_view';
...
export default {
    ...
    async index(request:Request, response:Response) {
        ...
        return response.json(orpahanageView.renderMany(orphanages));
    },
    ...
    async show(request:Request, response:Response) {
        ...
        return response.json(orpahanageView.render(orphanage));
    },
